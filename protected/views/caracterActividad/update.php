...
$this->breadcrumbs=array(
	...
	$model->id_caracter_actividad=>array('view','id'=>$model->id_caracter_actividad),
	Yii::t('app', 'Update'),
);
/*
$this->menu = array(
...
<h1>
    Caracter Actividad <small><?php echo Yii::t('app', 'Update'); ?> #<?php echo $model->id_caracter_actividad ?></small></h1><hr/>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_caracter_actividad)),'active'=>true, 'linkOptions'=>array()),
	),
));
$this->endWidget();*/
?>
