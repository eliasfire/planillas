...
<table align="center" class="tableizer-table">
  <tr class="tableizer-firstrow">
	...
	<th bgcolor="#0066CC">Totales</th>
	<th bgcolor="#0066CC">Varones</th>
 ...
 <td>Total Alumnos (debe contar a cada alumna una sola vez)   </td>
   ...
   <td bgcolor="#99FFCC">&nbsp;<?php echo $form->textField($model,'tot_act_var',array('class'=>'span1','value'=>$model->tot_act_var <> 0 ?  $model->tot_act_var : 0 ));?></td>
   <td bgcolor="#99FFCC">&nbsp;<?php echo $form->textField($model,'tot_act_muj',array('class'=>'span1','value'=>$model->tot_act_muj <> 0 ?  $model->tot_act_muj : 0 ));?></td>
   </tr>
 <tr>
 ...
 <tr>
	 ...
	 <td>&nbsp;<?php echo $form->textField($model,'alu_opt_var',array('class'=>'span1','readonly'=>'readonly','value'=>$model->alu_opt_var <> 0 ?  $model->alu_opt_var : 0 ));?></td>
	 <td>&nbsp;<?php echo $form->textField($model,'alu_opt_muj',array('class'=>'span1','readonly'=>'readonly','value'=>$model->alu_opt_muj <> 0 ?  $model->alu_opt_muj : 0 ));?></td>
    </tr>
 </table>
<?php $this->endWidget();?>
...
<script>
function sumar1(){  
var b =$('#Planilla_tot_act_var').val();
var c =$('#Planilla_tot_act_muj').val();
...
$('#Planilla_tot_act_var').keyup(sumar1);
$('#Planilla_tot_act_muj').keyup(sumar1);
</script>

<script>
function sumar1(){  
var b =$('#Planilla_alu_obl_var').val();
var c =$('#Planilla_alu_obl_muj').val();
...
$('#Planilla_alu_obl_var').keyup(sumar1);
$('#Planilla_alu_obl_muj').keyup(sumar1);
</script>

<script>
function sumar1(){  
var b =$('#Planilla_tot_act_var').val();
var c =$('#Planilla_alu_obl_var').val();
...
$('#Planilla_alu_opt_var').val(total);
}
$('#Planilla_tot_act_var').keyup(sumar1);
$('#Planilla_alu_obl_var').keyup(sumar1);
</script>
...
<script>
function sumar1(){  
var b =$('#Planilla_tot_act_muj').val();
var c =$('#Planilla_alu_obl_muj').val();
...
$('#Planilla_alu_opt_muj').val(total);
}
$('#Planilla_tot_act_muj').keyup(sumar1);
$('#Planilla_alu_obl_muj').keyup(sumar1);
</script>
...
var c =$('#Planilla_alu_opt_muj').val();
...
$('#Planilla_tot_act_var').keyup(sumar2);
$('#Planilla_alu_obl_var').keyup(sumar2);
