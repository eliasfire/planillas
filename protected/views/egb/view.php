...
<h1>
    Planilla - Educacion Común - Nivel Primario<small><?php echo Yii::t('app', 'View'); ?> #<?php echo $model->id_planilla ?></small></h1>
<hr />
                    ...
                    if (Yii::app()->user->checkAccess('Administrador'))
                    {
                    	...
                    	$this->widget('bootstrap.widgets.TbButton', array(
                    			...
                    			'htmlOptions'=>array(
                    					...
                    					{
                    					$.ajax({
                    					url: "'.$this->createUrl('egb/desconfirmar').'",
                    					dataType: "json",
                    					data: {
                    					confirmar: confirmed,
...
$this->widget('bootstrap.widgets.TbGroupGridView', array(
	...
	'dataProvider' => Egb::model()->getGridDataProvider($model->id_planilla),
	'template' => "{items}",
...
/* 		array(
		...
		array(
			'name'=>'alu_mat_tot',
	    	'header'=>'Total Alu Matri',
			'class'=>'bootstrap.widgets.TbTotalSumColumn'
		),
		array(
			'name'=>'alu_mat_var',
			'header'=>'Total Var Matri',
			'class'=>'bootstrap.widgets.TbTotalSumColumn'
		),
		array(
			'name'=>'alu_mat_muj',
	    	'header'=>'Total Muj Matri',
			'class'=>'bootstrap.widgets.TbTotalSumColumn'
		),
		array(
				'name'=>'nec_esp_edu',
		...
		array(
				'name'=>'alu_rep_tot',
				'header'=>'Total Alu Rep',
				'class'=>'bootstrap.widgets.TbTotalSumColumn'
		),
		array(
				'name'=>'alu_rep_var',
				'header'=>'Total Var Rep',
				'class'=>'bootstrap.widgets.TbTotalSumColumn'
		),
		array(
				'name'=>'alu_rep_muj',
				'header'=>'Total Muj Rep',
				'class'=>'bootstrap.widgets.TbTotalSumColumn'
		),
...
.tableizer-table th {
	...
	<table align="left" class="tableizer-table">
		<tr>
			<td bgcolor="#104E8B"><span class="ww"><span class="blanco">TOTAL INDEPENDIENTES</span></span></td>
			<td bgcolor="#104E8B" class="blanco"><span class="ww">TOTAL</span></td>
		</tr>
		<tr>
		  <td>de egb 1 y 2/ primario</td>
			<td bgcolor="#99FFCC"><?php echo $model->tot_ind_egb;?></td>
		</tr>
	</table>
  <table align="center" class="tableizer-table">
	  <tr>
	    <td bgcolor="#104E8B"><span class="ww">TOTAL MULTIPLES</span></td>
	    <td bgcolor="#104E8B" class="blanco"><span class="ww">TOTAL</span></td>
      </tr>
	  <tr>
	    <td>alumnos de egb 1 y 2/ primario exclusivamente</td>
	    <td bgcolor="#99FFCC"><?php echo $model->tot_mul_eex;?></td>
      </tr>
  </table>
	<p>&nbsp;</p>
	<table align="left" class="tableizer-table">
	  <tr>
	    <td width="255" bgcolor="#104E8B"><span class="ww"><span class="blanco">TOTAL DE SECCIONES/DIVISIONES</span></span></td>
			...
			$this->widget('bootstrap.widgets.TbButton', array(
				...
				'htmlOptions'=>array(
					...
					function(confirmed){
						...
						{
						$.ajax({
						url: "'.$this->createUrl('egb/confirmar').'",
						dataType: "json",
						data: {
								confirmar: confirmed,
								id: "'.$model->id_planilla.'",
...
$('#imprimir').click(function() {
    $("#cover").fadeIn(100);
    $.post(
            '<?php echo Yii::app()->createUrl('egb/imprimirLocalizacion'); ?>',
            $("#verticalForm, #verticalForm2").serialize(),
            function(res) {
              if (res.result) {
                downloadURL(res.archivo);
              } else {
              }
            }).done(function() {
      $("#cover").fadeOut(100);
