...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('orientacion-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>
    <?php echo Yii::t('app', 'Orientacions'); ?> <small><?php echo Yii::t('app', 'Manage'); ?></small></h1>
...
<?php  
     ...
     <?php 
        ...
        'buttons'=>array(
                array('label'=>Yii::t('app', 'Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'idTipoOrientacion - TipoOrientacion', 'url' =>array('tipoOrientacion/admin')),array('label'=>'detallePlanillas - DetallePlanilla', 'url' =>array('detallePlanilla/admin')),
            )
          ),
        ),
    ));
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		'codigo',
		array(
			'name'=>'id_tipo_orientacion',
			'value'=>'GxHtml::valueEx($data->idTipoOrientacion)',
			'filter'=>GxHtml::listDataEx(TipoOrientacion::model()->findAllAttributes(null, true)),
			),
		array(
