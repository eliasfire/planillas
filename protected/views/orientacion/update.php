...
$this->breadcrumbs=array(
	...
	$model->id_orientacion=>array('view','id'=>$model->id_orientacion),
	Yii::t('app', 'Update'),
);
/*
$this->menu = array(
...
<h1>
    Orientacion <small><?php echo Yii::t('app', 'Update'); ?> #<?php echo $model->id_orientacion ?></small></h1><hr/>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_orientacion)),'active'=>true, 'linkOptions'=>array()),
	),
));
$this->endWidget();*/
?>
