...
<?php echo  $form->dropDownListRow($model, 'id_tipo_orientacion', GxHtml::listDataEx(TipoOrientacion::model()->findAllAttributes(null, true))); ?>
                       </div>   
  </div>
...
?>	
   <script>
	$(".btnreset").click(function(){
		$(":input","orientacion-form").each(function() {
		var type = this.type;
