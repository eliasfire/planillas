<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>'Relations', 'icon'=>'icon-search', 'items'=>array(array('label'=>'idTipoOrientacion - TipoOrientacion', 'url' =>array('tipoOrientacion/admin')),array('label'=>'detallePlanillas - DetallePlanilla', 'url' =>array('detallePlanilla/admin')),
            )
          ),
        ),
    ));
