...
$this->breadcrumbs=array(
	...
	$model->id_establecimiento=>array('view','id'=>$model->id_establecimiento),
	Yii::t('app', 'Update'),
);
/*
$this->menu = array(
...
<h1>
    Establecimiento <small><?php echo Yii::t('app', 'Update'); ?> #<?php echo $model->id_establecimiento ?></small></h1><hr/>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_establecimiento)),'active'=>true, 'linkOptions'=>array()),
	),
));
$this->endWidget();*/
?>
