...
$this->menu=array(
	...
	array('label'=>Yii::t('app', 'Update') . ' ' . $model->label(), 'url'=>array('update', 'id' => $model->id_establecimiento)),
	array('label'=>Yii::t('app', 'Delete') . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->id_establecimiento), 'confirm'=>'Are you sure you want to delete this item?')),
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_establecimiento)), 'linkOptions'=>array()),
...
<?php $this->widget('bootstrap.widgets.TbExtendedGridView',array(
	'id'=>'localizacion-grid',
	'dataProvider'=>Localizacion::model()->getGridDataProvider($model->id_establecimiento),
