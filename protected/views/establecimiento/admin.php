...
<h1>
    <?php echo Yii::t('app', 'Establecimientos'); ?> <small><?php echo Yii::t('app', 'Manage'); ?></small></h1>
...
<?php  
     ...
     <?php 
        ...
        'buttons'=>array(
                array('label'=>Yii::t('app', 'Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'localizacions - Localizacion', 'url' =>array('localizacion/admin')),
            )
          ),
        ),
    ));
