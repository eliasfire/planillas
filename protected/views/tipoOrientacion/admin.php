...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('tipo-orientacion-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>
    <?php echo Yii::t('app', 'Tipo Orientacions'); ?> <small><?php echo Yii::t('app', 'Manage'); ?></small></h1>
...
<?php  
     ...
     <?php 
        ...
        'buttons'=>array(
                array('label'=>Yii::t('app', 'Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'orientacions - Orientacion', 'url' =>array('orientacion/admin')),
            )
          ),
        ),
    ));
