...
$this->breadcrumbs=array(
	...
	$model->id_tipo_orientacion=>array('view','id'=>$model->id_tipo_orientacion),
	Yii::t('app', 'Update'),
);
/*
$this->menu = array(
...
<h1>
    Tipo Orientacion <small><?php echo Yii::t('app', 'Update'); ?> #<?php echo $model->id_tipo_orientacion ?></small></h1><hr/>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_tipo_orientacion)),'active'=>true, 'linkOptions'=>array()),
	),
));
$this->endWidget();*/
?>
