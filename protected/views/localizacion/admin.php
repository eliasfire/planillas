...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('localizacion-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>
    <?php echo Yii::t('app', 'Localizacions'); ?> <small><?php echo Yii::t('app', 'Manage'); ?></small></h1>
...
<?php  
     ...
     <?php 
        ...
        'buttons'=>array(
                array('label'=>Yii::t('app', 'Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'idEstablecimiento - Establecimiento', 'url' =>array('establecimiento/admin')),
            )
          ),
        ),
    ));
