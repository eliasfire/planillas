...
$this->breadcrumbs=array(
	...
	$model->id_detalle_planilla=>array('view','id'=>$model->id_detalle_planilla),
	Yii::t('app', 'Update'),
);
/*
$this->menu = array(
...
<h1>
    Detalle Planilla <small><?php echo Yii::t('app', 'Update'); ?> #<?php echo $model->id_detalle_planilla ?></small></h1><hr/>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_detalle_planilla)),'active'=>true, 'linkOptions'=>array()),
	),
));
$this->endWidget();*/
?>
