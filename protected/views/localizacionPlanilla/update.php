...
$this->breadcrumbs=array(
	...
	$model->id_localizacion_planilla=>array('view','id'=>$model->id_localizacion_planilla),
	Yii::t('app', 'Update'),
);
/*
$this->menu = array(
...
<h1>
    Localizacion Planilla <small><?php echo Yii::t('app', 'Update'); ?> #<?php echo $model->id_localizacion_planilla ?></small></h1><hr/>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_localizacion_planilla)),'active'=>true, 'linkOptions'=>array()),
	),
));
$this->endWidget();*/
?>
