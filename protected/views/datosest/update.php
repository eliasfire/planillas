...
$this->breadcrumbs=array(
	...
	$model->id_datos_est=>array('view','id'=>$model->id_datos_est),
	Yii::t('app', 'Update'),
);
/*
$this->menu = array(
...
<h1>
    Datosest <small><?php echo Yii::t('app', 'Update'); ?> #<?php echo $model->id_datos_est ?></small></h1><hr/>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_datos_est)),'active'=>true, 'linkOptions'=>array()),
	),
));
$this->endWidget();*/
?>
