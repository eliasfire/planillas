...
.tableizer-table th {
	...
	<table class="tableizer-table">
		...
		<tr>
			<td bgcolor="#0066CC"><span class="blanco">PRIMARIO
		...
		<tr>
			<td><span class="segundo">Horas Destinadas al</span> DICTADO DE
				CLASES:</td>
			<td><?php echo $form->textField($model,'tot_dic_cla',array('class'=>'span1','readonly'=>'readonly','value'=>0));?>
			</td>
...
var c =$('#Datosest_tot_sec_tit').val();
var d =$('#Datosest_tot_pol_tit').val();
...
var total= parseFloat(b) + parseFloat(c) + parseFloat(d);
...
var c =$('#Datosest_tot_sec_int').val();
var d =$('#Datosest_tot_pol_int').val();
...
var d =$('#Datosest_tot_pol_tra').val();
...
var c =$('#Datosest_tot_sec_sup').val();
...
var c =$('#Datosest_tot_sec_sin').val();
var d =$('#Datosest_tot_pol_sin').val();
...
var c =$('#Datosest_tot_sec_pas').val();
var d =$('#Datosest_tot_pol_tar').val();
...
var c =$('#Datosest_tot_sec_com').val();
var d =$('#Datosest_tot_pol_com').val();
...
var c =$('#Datosest_tot_sec_lic').val();
var d =$('#Datosest_tot_pol_lic').val();
...
var c =$('#Datosest_tot_sec_con').val();
var d =$('#Datosest_tot_pol_con').val();
...
var b =$('#Datosest_tot_ind_sec').val();
var c =$('#Datosest_tot_ind_pol').val();
var d =$('#Datosest_tot_mul_eex').val();
var f =$('#Datosest_tot_mul_sex').val();
var g =$('#Datosest_tot_mul_esx').val();
var h =$('#Datosest_tot_mul_pex').val();
...
var total=parseFloat(a) + parseFloat(b) + parseFloat(c)+ parseFloat(d)+ parseFloat(f) + parseFloat(g) + parseFloat(h);
...
$('#Datosest_tot_mul_esx').keyup(sumar2);
