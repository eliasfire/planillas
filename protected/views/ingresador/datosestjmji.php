...
<?php	
 ...
 <div class="control-group">		
    ...
    <span class="span5"><?php echo $form->dropdownlistRow($model,'mes', $model->mesactivo,array("disabled"=>"disabled"));?></span>
    <span class="span4"><?php echo $form->dropdownlistRow($model,'anio', $model->anioactivo,array("disabled"=>"disabled","label"=>"Año"));?></span>
...
.tableizer-table th {
	...
	<table class="tableizer-table">
		...
		<tr>
			<td bgcolor="#0066CC"><span class="blanco">INICIAL</span></td>
...
.tableizer-table th {
	...
	<table align="center" class="tableizer-table">
		<tr class="tableizer-firstrow">
			<th>&nbsp;</th>
			<th bgcolor="#0066CC"><span class="qq">TOTAL</span></th>
			<th bgcolor="#0066CC" class="ww"><span class="qq">Varones</span></th>
			<th bgcolor="#0066CC"><span class="qq">Mujeres</span></th>
		</tr>
		<tr>
...
var c =$('#Datosest_tot_mul_jmx').val();
var d =$('#Datosest_tot_mul_jix').val();
var f =$('#Datosest_tot_mul_imx').val();
...
var total =  parseFloat(f) + parseFloat(g) + parseFloat(h) + parseFloat(i)
+ parseFloat(j);
