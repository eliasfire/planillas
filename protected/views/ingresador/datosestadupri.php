...
.tableizer-table th {
 ...
 <table class="tableizer-table">
		...
		<tr>
			<td bgcolor="#0066CC"><span class="form"><span class="blanco">JOVENES Y ADULTOS - PRIMARIO</span></span></td>
		...
		<tr>
		  ...
		  <td bgcolor="#99FFCC"><?php echo $form->textField($model,'tot_egb_tit',array('class'=>'span1','value'=>'0'));?></td>
		  <td bgcolor="#99FFCC"><?php echo $form->textField($model,'tot_egb_int',array('class'=>'span1','value'=>'0'));?></td>
		  <td bgcolor="#99FFCC"><?php echo $form->textField($model,'tot_egb_tra',array('class'=>'span1','value'=>'0'));?></td>
		  <td bgcolor="#99FFCC"><?php echo $form->textField($model,'tot_egb_sup',array('class'=>'span1','value'=>'0'));?></td>
		  <td bgcolor="#99FFCC"><?php echo $form->textField($model,'tot_egb_sin',array('class'=>'span1','value'=>'0'));?></td>
		  <td bgcolor="#99FFCC"><?php echo $form->textField($model,'tot_egb_pas',array('class'=>'span1','value'=>'0'));?></td>
		  <td bgcolor="#99FFCC"><?php echo $form->textField($model,'tot_egb_com',array('class'=>'span1','value'=>'0'));?></td>
		  <td bgcolor="#99FFCC"><?php echo $form->textField($model,'tot_egb_lic',array('class'=>'span1','value'=>'0'));?></td>
		  <td bgcolor="#99FFCC"><?php echo $form->textField($model,'tot_egb_con',array('class'=>'span1','value'=>'0'));?></td>
    </tr>
		<tr>
			<td><span class="form"><span class="aaa">Sistema Semipresencial de Primario (incluídas en anterior)</span></span></td>
...
function sumar1(e){  
var d =$('#Datosest_tot_egb_tit').val();
...
<script>
function sumar1(e){  
var d =$('#Datosest_tot_egb_tra').val();
...
<script>
function sumar1(e){  
var d =$('#Datosest_tot_egb_sin').val();
...
<script>
function sumar1(e){  
var d =$('#Datosest_tot_egb_pas').val();
...
<script>
function sumar1(e){  
var d =$('#Datosest_tot_egb_com').val();
...
var d =$('#Datosest_tot_egb_lic').val();
...
<script>
function sumar1(e){  
var d =$('#Datosest_tot_egb_con').val();
...
$('#Datosest_tot_egb_tit').keyup(sumar3);
...
$('#Datosest_tot_egb_div').val(total);
}
