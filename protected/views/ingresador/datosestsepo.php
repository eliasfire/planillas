...
.tableizer-table th {
	...
	<table class="tableizer-table">
		...
		<tr>
			<td bgcolor="#0066CC"><span class="blanco">SECUNDARIO - POLIMODAL</span></td>
...
<script>
function sumar1(e){  
var b =$('#Datosest_tot_sec_tit').val();
var c =$('#Datosest_tot_pol_tit').val();
if(b==''){b=0;}
if(c==''){c=0;}
...
var c =$('#Datosest_tot_pol_int').val();
...
<script>
function sumar1(e){  
var b =$('#Datosest_tot_sec_tra').val();
...
<script>
function sumar1(e){  
var b =$('#Datosest_tot_sec_sup').val();
var c =$('#Datosest_tot_pol_sup').val();
...
<script>
function sumar1(e){  
var b =$('#Datosest_tot_sec_sin').val();
var c =$('#Datosest_tot_pol_sin').val();
...
<script>
function sumar1(e){  
var b =$('#Datosest_tot_sec_pas').val();
var c =$('#Datosest_tot_pol_tar').val();
...
<script>
function sumar1(e){  
var b =$('#Datosest_tot_sec_com').val();
var c =$('#Datosest_tot_pol_com').val();
...
<script>
function sumar1(e){  
var b =$('#Datosest_tot_sec_lic').val();
var c =$('#Datosest_tot_pol_lic').val();
...
<script>
function sumar1(e){  
var b =$('#Datosest_tot_sec_con').val();
var c =$('#Datosest_tot_pol_con').val();
...
$('#Datosest_tot_sec_pas').keyup(sumar1);
$('#Datosest_tot_pol_pas').keyup(sumar1);
...
<script>
function sumar2(e){  
var a =$('#Datosest_tot_ind_sec').val();
var b =$('#Datosest_tot_ind_pol').val();
var c =$('#Datosest_tot_mul_sex').val();
var d =$('#Datosest_tot_mul_pex').val();
