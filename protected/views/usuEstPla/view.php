...
$this->breadcrumbs=array(
	...
	$model->id_usu_est_pla,
);
/*
$this->menu=array(
	array('label'=>Yii::t('app', 'List') . ' ' . $model->label(2), 'url'=>array('index')),
	array('label'=>Yii::t('app', 'Create') . ' ' . $model->label(), 'url'=>array('create')),
	array('label'=>Yii::t('app', 'Update') . ' ' . $model->label(), 'url'=>array('update', 'id' => $model->id_usu_est_pla)),
	array('label'=>Yii::t('app', 'Delete') . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->id_usu_est_pla), 'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>Yii::t('app', 'Manage') . ' ' . $model->label(2), 'url'=>array('admin')),
);*/
?>

<h1>
    Usu Est Pla <small><?php echo Yii::t('app', 'View'); ?> #<?php echo $model->id_usu_est_pla ?></small></h1>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_usu_est_pla)), 'linkOptions'=>array()),
...
array(
					'name' => 'idUsuario',
					'type' => 'raw',
					'value' => $model->idUsuario !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->idUsuario)), array('user/view', 'id' => GxActiveRecord::extractPkValue($model->idUsuario, true))) : null,
					),
array(
