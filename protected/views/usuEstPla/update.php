...
$this->breadcrumbs=array(
	...
	$model->id_usu_est_pla=>array('view','id'=>$model->id_usu_est_pla),
	Yii::t('app', 'Update'),
);
/*
$this->menu = array(
...
<h1>
    Usu Est Pla <small><?php echo Yii::t('app', 'Update'); ?> #<?php echo $model->id_usu_est_pla ?></small></h1><hr/>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_usu_est_pla)),'active'=>true, 'linkOptions'=>array()),
	),
));
$this->endWidget();*/
?>
