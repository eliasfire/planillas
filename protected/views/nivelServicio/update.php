...
<h1>
    Nivel Servicio <small><?php echo Yii::t('app', 'Update'); ?> #<?php echo $model->id_nivel ?></small></h1><hr/>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_nivel)),'active'=>true, 'linkOptions'=>array()),
	),
));
$this->endWidget();*/
?>
