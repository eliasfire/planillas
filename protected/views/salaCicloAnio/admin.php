...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('sala-ciclo-anio-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>
    <?php echo Yii::t('app', 'Sala Ciclo Anios'); ?> <small><?php echo Yii::t('app', 'Manage'); ?></small></h1>
...
<?php  
     ...
     <?php 
        ...
        'buttons'=>array(
                array('label'=>Yii::t('app', 'Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'idNivel - NivelServicio', 'url' =>array('nivelServicio/admin')),array('label'=>'detallePlanillas - DetallePlanilla', 'url' =>array('detallePlanilla/admin')),
            )
          ),
        ),
    ));
