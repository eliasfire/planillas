...
$this->breadcrumbs=array(
	...
	$model->id_sala_ciclo_anio=>array('view','id'=>$model->id_sala_ciclo_anio),
	Yii::t('app', 'Update'),
);
/*
$this->menu = array(
...
<h1>
    Sala Ciclo Anio <small><?php echo Yii::t('app', 'Update'); ?> #<?php echo $model->id_sala_ciclo_anio ?></small></h1><hr/>
...
$this->widget('bootstrap.widgets.TbMenu', array(
	...
	'items'=>array(
        ...
        array('label'=>Yii::t('app', 'Update'), 'icon'=>'icon-edit', 'url'=>Yii::app()->controller->createUrl('update',array('id'=>$model->id_sala_ciclo_anio)),'active'=>true, 'linkOptions'=>array()),
	),
));
$this->endWidget();*/
?>
