...
<h1>
    <?php echo Yii::t('app', 'Users'); ?> <small><?php echo Yii::t('app', 'Manage'); ?></small></h1>
...
<?php  
     ...
     <?php 
        ...
        'buttons'=>array(
                array('label'=>Yii::t('app', 'Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'usuEstPlas - UsuEstPla', 'url' =>array('usuEstPla/admin')),
            )
          ),
        ),
    ));
