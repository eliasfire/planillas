	...
	<div class="complex">
		...
		<div class="panel">
			<table class="templateFrame grid" cellspacing="0">
				<thead class="help-block">
					<tr >
						<td>
							<?php echo $form->labelEx(EducacionNoFormal::model(),'firstname');?>
						</td>
						<td>
							<?php echo $form->labelEx(EducacionNoFormal::model(),'lastname');?>
						</td>
						<td colspan="2">
							<?php echo $form->labelEx(EducacionNoFormal::model(),'eyecolor_code');?>
						</td>
					</tr>
				</thead>
				<tfoot>
						...
						<td colspan="4">
							...
							<textarea class="template" rows="0" cols="0">
								<tr class="help-block">
									...
									<td>
										<?php /* echo CHtml::dropDownList('Person[{0}][eyecolor_code]','',GxHtml::listDataEx(Establecimiento::model()->findAllAttributes(null, true)),array('style'=>'width:100px','prompt'=>'')); */ ?>
									</td>
									<td>
