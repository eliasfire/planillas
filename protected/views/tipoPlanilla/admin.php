...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('tipo-planilla-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>
    <?php echo Yii::t('app', 'Tipo Planillas'); ?> <small><?php echo Yii::t('app', 'Manage'); ?></small></h1>
...
<?php  
     ...
     <?php 
        ...
        'buttons'=>array(
                array('label'=>Yii::t('app', 'Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'localizacionPlanillas - LocalizacionPlanilla', 'url' =>array('localizacionPlanilla/admin')),array('label'=>'planillas - Planilla', 'url' =>array('planilla/admin')),
            )
          ),
        ),
    ));
