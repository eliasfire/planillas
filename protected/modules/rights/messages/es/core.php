 ...
 */
return array (
  'A role is group of permissions to perform a variety of tasks and operations, for example the authenticated user.' => 'Un Rol es un grupo de permisos para realizar una cierta cantidad de tareas y operaciones, como por ejemplo un usuario que inicia sesión',
  'A task is a permission to perform multiple operations, for example accessing a group of controller action.' => 'Una tarea es un permiso para multiples operaciones, como por ejemplo acceder a un grupo de acciones ed un controlador',
  'An operation is a permission to perform a single operation, for example accessing a certain controller action.' => 'Una operación es un permiso para realizar una sola acción, como por ejemplo acceder a la acción view del controlador User',
  'Authorization items can be managed under {roleLink}, {taskLink} and {operationLink}.' => 'Los items de autorización pueden ser manejados via {roleLink}, {taskLink} {operationLink}.',
  'Cancel' => 'Cancelar',
  'Generate items' => 'Generar items.',
  'Generate items for controller actions' => 'Generar los items para las acciones de sus controladores.',
  'Here you can view and manage the permissions assigned to each role.' => 'Aca usted puede ver y administrar los permsiso asignados a cada rol.',
  'Here you can view which permissions has been assigned to each user.' => 'Aca usted puede ver los permisos que han sido asignados a cada usuario.',
