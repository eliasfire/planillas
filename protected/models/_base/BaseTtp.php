 ...
 */
abstract class BaseTtp extends GxActiveRecord {
	...
	public function getGridDataProvider($id) {
		...
		$criteria->addCondition('nombre_itinerario IS NULL');
