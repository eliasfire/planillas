 ...
 */
abstract class BaseItinerario extends GxActiveRecord {
	...
	public function getGridDataProvider($id) {
		...
		//$criteria->compare('nombre_ttp', null, true);
		$criteria->addCondition('nombre_ttp IS NULL');
