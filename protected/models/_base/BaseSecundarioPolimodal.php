 ...
 */
abstract class BaseSecundarioPolimodal extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('nombre_seccion, id_sala_ciclo_anio, id_nivel, id_seccion, alu_mat_tot, alu_mat_var, alu_rep_tot, alu_rep_var, id_turno, id_orientacion,nec_esp_edu', 'required'),
		);
	}
	...
	public function getGridDataProvider($id) {
		...
		$_SESSION['planilla_secundario'] = 	 new CActiveDataProvider($this, array(
				...
				'sort'=>array(
						'attributes'=>array(
							'id_nivel',array(
                  			  'asc' => 'id_sala_ciclo_anio ASC,id_turno',
                          ) 
						),
						'defaultOrder' => 'id_sala_ciclo_anio,id_turno,nombre_seccion asc',
				),
				'pagination' => array(
						'pagesize' => 30,
				),
