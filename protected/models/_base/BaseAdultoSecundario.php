 ...
 */
abstract class BaseAdultoSecundario extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('nombre_seccion, id_sala_ciclo_anio, id_seccion, alu_mat_tot, alu_mat_var, id_turno, id_orientacion,id_titulo', 'required'),
		);
	}
	...
	public function relations() {
		return array(
			...
			'idOrientacionTipo' => array(self::BELONGS_TO, 'OrientacionTipo', 'id_orientacion'),
	...
	public function attributeLabels() {
		return array(
			...
			'id_nivel' =>  'Nivel',
			'id_seccion' => null,
			'id_orientacion' => Yii::t('app', 'Orientacion'),
	...
	public function getGridDataProvider($id) {
		...
		$_SESSION['planilla_secundario'] = 	 new CActiveDataProvider($this, array(
				'criteria' => $criteria,
				'sort'=>array(
						'attributes'=>array(
							'id_nivel',array(
	...
	public function calcularMujeres($id)
	{
		...
		$items=Inicial::model()->findAll(array('condition'=>'id_planilla=:x', 'params'=>array(':x'=>$id)));
