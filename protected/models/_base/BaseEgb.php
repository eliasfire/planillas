 ...
 */
abstract class BaseEgb extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('nombre_seccion, id_sala_ciclo_anio, id_seccion, alu_mat_tot, alu_mat_var, alu_rep_tot, alu_rep_var, nec_esp_edu, id_turno, alu_med_tot, alu_med_var', 'required'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			...
			'id_sala_ciclo_anio' => Yii::t('app', 'Año'),
			'id_nivel' =>  'Nivel',
			'id_seccion' => null,
			...
			'alu_med_tot' => Yii::t('app', 'Total Asis Medica'),
			'alu_med_var' => Yii::t('app', 'Total Asis Medica Varones'),
			'alu_med_muj' => Yii::t('app', 'Total Asis Medica Mujeres'),
			'idSeccion' => null,
			'idPlanilla' => null,
			'idLocalizacion' => null,
	...
	public function getGridDataProvider($id) {
		...
		$_SESSION['planilla_egb'] = new CActiveDataProvider($this, array(
				'criteria' => $criteria,
				'sort'=>array(
						'attributes'=>array(
							'id_nivel',array(
                  			  'asc' => 'id_turno ASC, id_sala_ciclo_anio ASC',
              			      'desc' => 'id_turno DESC, id_sala_ciclo_anio ASC',
                          ) 
						),
						'defaultOrder' => 'id_turno,id_sala_ciclo_anio',
				),
				'pagination' => array(
						'pagesize' => 30,
				),
		...
		return new CActiveDataProvider($this, array(
				...
				'sort'=>array(
						...
						'defaultOrder' => 'id_turno,id_sala_ciclo_anio,nombre_seccion',
				),
				'pagination' => array(
						'pagesize' => 30,
				),
