 ...
 * @property integer $otr_ser_ali
 * @property integer $tot_alu_iti
 * @property integer $tot_iti_man
 * @property integer $tot_iti_tar
 * @property integer $tot_iti_ves
 * @property integer $tot_iti_noc
 * @property integer $tot_iti_dob
 * @property integer $tot_alu_ttp
 * @property integer $tot_ttp_man
 * @property integer $tot_ttp_tar
 * @property integer $tot_ttp_ves
 * @property integer $tot_ttp_noc
 * @property integer $tot_ttp_dob
 * @property integer $tot_iti_ttp
 * @property integer $tot_alu_man
 * @property integer $tot_alu_tar
 * @property integer $tot_alu_ves
 * @property integer $tot_alu_noc
 * @property integer $tot_alu_dob
 *
...
abstract class BasePlanilla extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('id_tipo_planilla, id_establecimiento, ingresador,tot_ind_jam,tot_ind_jif,tot_mul_jmx,tot_mul_jix,tot_mul_imx,tot_sec_div,tot_alm_ben,tot_cop_man,tot_cop_tar,tot_ref_man,tot_ref_tar,otr_ser_ali', 'required', 'on'=>'inicial'),
			...
			array('id_tipo_planilla, id_establecimiento, ingresador,tot_alu_iti, tot_iti_man, tot_iti_tar, tot_iti_ves, tot_iti_noc, tot_iti_dob, tot_alu_ttp, tot_ttp_man, tot_ttp_tar, tot_ttp_ves, tot_ttp_noc, tot_ttp_dob, tot_iti_ttp, tot_alu_man, tot_alu_tar, tot_alu_ves, tot_alu_noc, tot_alu_dob', 'required', 'on'=>'ttp'),
			array('id_tipo_planilla, id_establecimiento, ingresador', 'required', 'on'=>'itinerario'),
			array('id_tipo_planilla, id_establecimiento, ingresador,tot_sec_div,tot_alm_ben,tot_cop_man,tot_cop_tar,tot_ref_man,tot_ref_tar,otr_ser_ali', 'required', 'on'=>'secundaria'),
			
			array('id_tipo_planilla, id_establecimiento, ingresador,tot_ind_egb,tot_mul_eex,tot_sec_div,tot_alm_ben,tot_cop_man,tot_cop_tar,tot_ref_man,tot_ref_tar,otr_ser_ali', 'required', 'on'=>'egb'),
	...
	public function attributeLabels() {
		return array(
			...
			'tot_alu_iti' => Yii::t('app', 'Tot Alu Iti'),
			'tot_iti_man' => Yii::t('app', 'Tot Iti Man'),
			'tot_iti_tar' => Yii::t('app', 'Tot Iti Tar'),
			'tot_iti_ves' => Yii::t('app', 'Tot Iti Ves'),
			'tot_iti_noc' => Yii::t('app', 'Tot Iti Noc'),
			'tot_iti_dob' => Yii::t('app', 'Tot Iti Dob'),
			'tot_alu_ttp' => Yii::t('app', 'Tot Alu Ttp'),
			'tot_ttp_man' => Yii::t('app', 'Tot Ttp Man'),
			'tot_ttp_tar' => Yii::t('app', 'Tot Ttp Tar'),
			'tot_ttp_ves' => Yii::t('app', 'Tot Ttp Ves'),
			'tot_ttp_noc' => Yii::t('app', 'Tot Ttp Noc'),
			'tot_ttp_dob' => Yii::t('app', 'Tot Ttp Dob'),
			'tot_iti_ttp' => Yii::t('app', 'Tot Iti Ttp'),
			'tot_alu_man' => Yii::t('app', 'Tot Alu Man'),
			'tot_alu_tar' => Yii::t('app', 'Tot Alu Tar'),
			'tot_alu_ves' => Yii::t('app', 'Tot Alu Ves'),
			'tot_alu_noc' => Yii::t('app', 'Tot Alu Noc'),
			'tot_alu_dob' => Yii::t('app', 'Tot Alu Dob'),
			'idTipoPlanilla' => null,
	...
	public function search() {
		...
		$criteria->compare('tot_alu_iti', $this->tot_alu_iti);
		$criteria->compare('tot_iti_man', $this->tot_iti_man);
		$criteria->compare('tot_iti_tar', $this->tot_iti_tar);
		$criteria->compare('tot_iti_ves', $this->tot_iti_ves);
		$criteria->compare('tot_iti_noc', $this->tot_iti_noc);
		$criteria->compare('tot_iti_dob', $this->tot_iti_dob);
		$criteria->compare('tot_alu_ttp', $this->tot_alu_ttp);
		$criteria->compare('tot_ttp_man', $this->tot_ttp_man);
		$criteria->compare('tot_ttp_tar', $this->tot_ttp_tar);
		$criteria->compare('tot_ttp_ves', $this->tot_ttp_ves);
		$criteria->compare('tot_ttp_noc', $this->tot_ttp_noc);
		$criteria->compare('tot_ttp_dob', $this->tot_ttp_dob);
		$criteria->compare('tot_iti_ttp', $this->tot_iti_ttp);
		$criteria->compare('tot_alu_man', $this->tot_alu_man);
		$criteria->compare('tot_alu_tar', $this->tot_alu_tar);
		$criteria->compare('tot_alu_ves', $this->tot_alu_ves);
		$criteria->compare('tot_alu_noc', $this->tot_alu_noc);
		$criteria->compare('tot_alu_dob', $this->tot_alu_dob);
